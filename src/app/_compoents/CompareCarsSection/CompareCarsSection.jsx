    ...
    <div className="container mx-auto px-4 relative z-10">
      ...
      <div className="bg-background/90 backdrop-blur supports-[backdrop-filter]:bg-background/60 rounded-xl shadow-lg overflow-hidden transform hover:scale-105 transition duration-500 ease-in-out">
        <div className="p-8">
          ...
          >
            {[
              { text: t("sideBySideComparison"), icon : <FaBalanceScale className="h-6 w-6 mr-3 text-gray-50" /> },
              { text: t("detailedSpecifications"), icon : <FaCarRear  className="h-6 w-6 mr-3 text-emerald-500" /> },
              { text: t("unbiasedReviews"), icon : <MdPreview  className="h-6 w-6 mr-3 text-red-500" /> },
            ].map((feature, index) => (
              <div
                key={index}
