...
import ProductFilterHeader from "../_compoents/PrdocutFilter/ProductFilterHeader";
            ...
            <div className="p-4 border rounded-lg  text-[--text-color] shadow-sm">
              ...
              <div className="space-y-2">
                <p>
                  ...
                  1234 Car Street, Automobile City, AC 56789
                </p>
                <p>
                  <span className="font-bold text-[--text-color]">Phone:</span>{" "}
                  (123) 456-7890
                </p>
                <p>
                  <span className="font-bold text-[--text-color]">Email:</span>{" "}
                  info@carhub.com
                </p>
              </div>
            </div>
              ...
              <table className="w-full text-sm text-[--text-color]">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="text-right">10:00 AM - 4:00 PM</td>
                  </tr>
                  <tr>
