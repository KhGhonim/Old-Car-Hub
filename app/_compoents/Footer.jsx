    ...
    <footer className="bg-black text-white ">
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 border-t border-gray-100 pt-16 md:grid-cols-4 lg:grid-cols-6">
          ...
          <div className="text-center sm:text-left">
            <p className="text-lg font-medium text-gray-200">Resources</p>
          ...
          <div className="text-center sm:text-left md:col-span-4 lg:col-span-2">
            <p className="text-lg font-medium text-gray-100">Stay in Touch</p>

            <div className="mx-auto mt-8 max-w-md sm:ms-0">
              <p className="text-center leading-relaxed text-gray-500 ltr:sm:text-left  :sm:text-right">
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Earum
                id, iure consectetur et error hic!
              </p>

              <form id="Contact" className="mt-4" onSubmit={handleSubmit}>
                <div className="flex flex-col gap-4 sm:flex-row lg:flex-col lg:items-start">
                  ...
                  {state.errors && (
                    <p>
                      There's an error in submitting your subscribe, Please try
                      again later!
                    </p>
                  )}
                  ...
                  <button
                    ...
                    onClick={notify}
                  >
                    {state.submitting ? <p>Submiting....</p> : <p>Submit</p>}
                    <ToastContainer />
                  </button>
                </div>
              </form>
        ...
        <div className="mt-16 border-t border-gray-100 pt-6 sm:flex sm:items-center sm:justify-between ">
          <p className="text-center text-sm text-gray-500 sm:text-left">
            Copyright &copy; 2024. All rights reserved For Khaled Ghonim.
          </p>
